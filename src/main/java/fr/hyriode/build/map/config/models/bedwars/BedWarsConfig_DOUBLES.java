 ...
 */
@ConfigData(name = "BedWars Doubles")
public class BedWarsConfig_DOUBLES extends GameConfig {
    ...
    private final List<Team> teams = new ArrayList<Team>(){{
        ...
        this.add(new Team("aqua", "§bAqua"));
        this.add(new Team("pink", "§dRose"));
        this.add(new Team("white", "§fBlanc"));
        this.add(new Team("gray", "§7Gris"));
    }};
